 	...
 	<div class="container">
 		<div class="row">
 				...
 				<div class="col-md-8"><!-- right -->
 					<h2 style="text-align: center;">Nuoc Giai Khat</h2><br>
					...
					<input type="hidden" name="action" value="NuocGiaiKhat">
					<select name="sort">
					...
					<input type="submit" value="Go!">
 					...
 					<c:forEach items="${list }" var="product">
 						...
 						<c:if test="${product.getCategory() == 'NuocGiaiKhat' }">
		 					...
		 					<div class="col-md-4">
		 						...
		 						<div class="text-center">  <a class="btn btn-primary" href="Controller?page=addtocart&action=NuocGiaiKhat&id=<c:out value="${product.getId()}"/>">Add to Cart</a> </div><br>
		 					</div>
 			...
 			<div class="paging" style="display: flex; justify-content: center; align-items: center;">
		 			<c:forEach begin="1" end="${endPage }" var="i">
				 		<a href="Controller?page=NuocGiaiKhat&index=${i}" 
				 					 style="float: left;
											padding: 8px 16px;
